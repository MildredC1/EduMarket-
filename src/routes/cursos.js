...
import { listarCursos, crearCurso, verDetalleCurso,actualizarCurso,listarCursosInstructor,listarMisCursos,inscribirseCurso } from '../controllers/cursosController.js';
import { verificarSesion } from '../middlewares/sesion.js';
import { soloAdminOInstructor, soloInstructor ,soloEstudiante} from '../middlewares/roles.js';
...
router.post('/:id/inscribirse', verificarSesion, soloEstudiante, inscribirseCurso);
router.get('/mis-cursos-estudiante', verificarSesion, soloEstudiante, listarMisCursos);
